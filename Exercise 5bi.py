...
VFIN= float(FIN.Smk_1_tob_use_M)
VSWE= float(SWE.Smk_1_tob_use_M)
VDEN= float(DEN.Smk_1_tob_use_M)
VNOR= float(NOR.Smk_1_tob_use_M)
VICE= float(ICE.Smk_1_tob_use_M)
